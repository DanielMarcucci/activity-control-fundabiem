...
export default function Headding(props) {
	let { url } = useRouteMatch()

  return (
    <header className="bg-white shadow">
      <div className="flex items-center justify-between max-w-7xl mx-auto py-6 px-4">
        ...
        <div className="flex lg:mt-0 lg:ml-4">
          <span>
            {props.showButtonNew ?
              ...
              >
                <ViewGridAddIcon className="-ml-1 mr-2 h-5 w-5 text-gray-500" aria-hidden="true" />
                Nuevo
              </Link>
              : <></>
            }
